...
public class BinPackPartitionAssignor extends AbstractAssignor {
    ...
    private static void assignController(
        ...
        for (String co : consumers) {
            ConsumerGrpc controllerconsumer = null;
            for(ConsumerGrpc contcons : asscons) {
            ...
            for (PartitionGrpc p : controllerconsumer.getAssignedPartitionsList()) {
    ...
    private static List<metricsfromkafka.ConsumerGrpc> callForAssignment() {
